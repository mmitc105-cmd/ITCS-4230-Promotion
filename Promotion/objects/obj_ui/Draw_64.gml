draw_set_color(c_black);
    ...
    // 2. Draw your puzzle UI box (centering a box on screen)
    ...
    // 3. Draw text instructions for the puzzle
    draw_set_color(c_white);
    draw_set_halign(fa_center);
    draw_text(_ui_x, _ui_y - 100, "PUZZLE ACTIVE");
    draw_text(_ui_x, _ui_y, "Solve the riddle...");
    draw_text(_ui_x, _ui_y + 100, "Press 'E' or 'Escape' to Exit");
    
    // Reset text alignment back to default left-align
